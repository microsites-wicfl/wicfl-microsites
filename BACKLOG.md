...
| W-011 | Registrar dominios de sitios #1 y #2 vía Cloudflare Registrar | Vic | Depende de W-007, que ahora depende de W-016. **Nota 2026-09-03:** Kevin ya compró/posee `StuartHomeownersInsurance.com` según su mensaje del chat de Zoom, pero no se sabe con qué registrador ni si ya apunta a nameservers de Cloudflare. Confirmar antes de dar este item por resuelto para el sitio #1 |
