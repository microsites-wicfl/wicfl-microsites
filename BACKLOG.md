...
| W-012 | Crear org de GitHub y monorepo, configurar accesos | Vic | **Avance 2026-09-02:** `main` y la historia local completa se subieron a `microsites-wicfl/wicfl-microsites` sin force y GitHub la dejó como rama por defecto. GitHub registró los tres workflows como activos, pero la consulta de Actions devolvió 0 runs; W-012 no se cierra hasta tener CI verde. **Decisión de identidad:** `microsites@wicfl.com` es Owner de la org; las personas entran con su cuenta propia, nunca con la del buzón. `vitoriomanzarek` tiene escritura. Prompt: `prompts/2026-09-01_003_conectar-remoto.md`; reporte: `reports/2026-09-01_003_conectar-remoto.md`. Avance previo: monorepo local, workspace npm y CI base en `1c37278`. |
