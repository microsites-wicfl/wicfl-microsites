...
| W-107 | ~~Renderer de markdown real, con content collections de Astro~~ | Vic | **Cerrado 2026-09-02.** Astro content collections load external site markdown through the generator environment, with required frontmatter and full markdown rendering. Prompt: `prompts/2026-09-02_007_template-y-markdown.md`; reporte: `reports/2026-09-02_007_template-y-markdown.md`; commit: `8e4a277` (`feat(template): real markdown pipeline and design system`). |
| W-021 | Template base de Astro: layouts, componentes, design system | Vic | **Avance 2026-09-02:** shared tokens, the three constrained theme variants, responsive layout, NAP footer, prominent human-readable phone with E.164 `tel:`, license disclosure, and home/content/coverage page types are in `8e4a277`. It remains open because `npm run check` still only validates configs; restore the local `astro check` before closing. Prompt: `prompts/2026-09-02_007_template-y-markdown.md`; reporte: `reports/2026-09-02_007_template-y-markdown.md`. |
