...
| W-012 | Crear org de GitHub y monorepo, configurar accesos | Vic | **Avance 2026-09-02:** rama local renombrada a `main` y `origin` configurado para `microsites-wicfl/wicfl-microsites`; el push normal fue rechazado con HTTP 403 para la cuenta autenticada y no se forzó. **Decisión de identidad tomada el 2026-09-02:** `microsites@wicfl.com` es Owner de la org; las personas entran con su cuenta propia, nunca con la del buzón. `vitoriomanzarek` se agrega como miembro con permiso de escritura y se reintenta el push. Autenticar la máquina como el buzón produciría un historial donde todo lo firma un buzón y nadie sabe quién hizo qué, además de dejar una credencial compartida en la máquina de trabajo. Lo mismo aplica a Pavel cuando entre. Prompt: `prompts/2026-09-01_003_conectar-remoto.md`; reporte: `reports/2026-09-01_003_conectar-remoto.md`. Avance previo: monorepo local, workspace npm y CI base en `1c37278`. |
